...
You will notice it features a <code>build.gradle</code> file to let you build, test, run and deploy your project.
This build file is using the <a href="http://gradle.org">Gradle</a> build system, which is using the <b>Groovy</b> language for its build description DSL.
</p>

<p>Here's our layout for the template project:<img src="/images/directory.png"></p>
