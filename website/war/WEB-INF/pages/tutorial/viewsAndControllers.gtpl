...
<p>
Beyond those standard Servlet variables provided by Groovy's servlet binding, <b>Caelyf</b> also adds a few of it's own
...
<ul>
    ...
    <li>
        <tt>logger</tt> : a convenience variable which is connected to groovyx.caelyf.logging.LoggerAccessor when the application is running, and when deployed on Cloud Foundry.
    </li>
    <li>
